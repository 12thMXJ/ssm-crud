...
<script type="text/javascript">
    ...
    function build_emps_table(result) {
        ...
        $.each(emps,function (index, item) {
            ...
            //可以链式书写的原因是：append方法执行完成以后还是返回原来的元素
    ...
    function getDepts(ele) {
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                //显示部门信息在下拉列表中
                //因为在添加的模态框中只有一个下拉选项框，所以可以直接通过子标签查找
    ...
    //修改按钮的点击事件
    //1、我们是按钮创建之后就绑定了click，所以绑定不上。
    //1、可以在创建按钮的时候绑定。  2、绑定点击.live()
    //jquery新版没有live，可以使用on进行替代
    ...
    $("#check_all").click(function () {
        ...
        //对于dom原生的属性：可以用prop去读取
        //attr与prop的区别
        //1、attr获取自定义属性的值；
        //2、prop修改和读取dom原生属性的值；
