...
import com.yolo.crud.service.EmployeeService;
...
public class EmployeeController {
     ...
     *              会把POJO中的每个属性的值，调用request.getParameter("empName")方法进行封装
     *
     * ajax发送PUT请求引发的问题：
     *      1、PUT请求，请求体中的数据，request.getParameter("empName")拿不到
     *      2、Tomcat一看是PUT请求就不会封装请求体中的数据为map，只有POST形式的请求才会封装请求体为map
     *
     *
     * 解决方案：
